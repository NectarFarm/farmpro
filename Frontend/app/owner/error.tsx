...
export default function OwnerError({
  ...
  return (
    <div className="h-full min-h-[60vh] flex items-center justify-center bg-gray-50 p-6">
      <div className="max-w-md w-full bg-white rounded-2xl border border-destructive/30 shadow-sm p-8 text-center">
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={reset}
            className="px-5 py-2.5 bg-primary text-primary-foreground rounded-lg font-semibold text-sm hover:bg-primary/90"
          >
            Try again
          </button>
          <Link

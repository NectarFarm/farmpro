...
5. **Production & harvest** — Eggs collected, meat sold (by weight, age, price), fish harvested, maize and crop yields by plot.
...
IFMS is a SaaS platform. Potential revenue lines to validate in the pilot:
- **Subscription** per farm, tiered by number of production units / workers.
- **Premium analytics & reporting** (donor/lender-ready report packs).
...
| Phase | Timeline | Goal |
|---|---|---|
| **1 — Pilot build** | Months 0–3 | Worker mobile app + owner dashboard; deploy on founder's own farm |

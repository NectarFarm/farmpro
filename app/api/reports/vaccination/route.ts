...
import { computeVaccinationReport, parseDateRange, InvalidDateRangeError, REPORT_VIEWER_ROLES } from '@/lib/reports'
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const report = await computeVaccinationReport(tenantId, from, to, farmFilter ?? undefined)
    return ok(report)
  } catch (err) {
